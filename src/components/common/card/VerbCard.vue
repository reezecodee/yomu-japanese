...
<template>
    <div
        ...
        <div class="mt-4 space-y-2">
            ...
            <div
                class="form-box form-dict bg-slate-100 border-2 border-slate-300 text-slate-500 rounded-xl p-2 text-center">
            ...
            <div
                class="form-box form-masu bg-rose-50 border-2 border-rose-600 text-rose-600 rounded-xl p-2 text-center">
