    ...
    <div class="relative h-12 flex justify-end pointer-events-none z-20">
        <div class="flex items-start transition-transform duration-300 ease-in-out pointer-events-none"
            ...
            <button @click="isOpen = !isOpen"
                class="pointer-events-auto w-12 h-12 bg-peach-accent hover:bg-peach text-white flex items-center justify-center rounded-l-xl border-y-4 border-l-4 border-slate-800 shadow-[-4px_4px_0px_rgba(0,0,0,0.2)] relative z-20 focus:outline-none transition-colors cursor-pointer"
            ...
            <div
                class="pointer-events-auto bg-white border-y-4 border-l-4 border-slate-800 p-4 rounded-bl-xl shadow-[-6px_6px_0px_#1e293b] flex flex-col gap-3 min-w-[140px]">
