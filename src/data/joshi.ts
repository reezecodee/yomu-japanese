...
export const ExtraParticles: JoshiExtraItem[] = [
  {
    ...
    example: "Senin kara (Dari hari Senin)",
  },
  {
    kana: "まで",
    romaji: "Made (Sampai)",
    desc: "Menunjukkan batas akhir waktu/tempat.",
    example: "Jumat made (Sampai hari Jumat)",
  },
  {
    kana: "ね",
    romaji: "Ne (Ya? / Kan?)",
    desc: "Di akhir kalimat untuk mencari persetujuan lawan bicara (Softener).",
    example: "Oishii desu ne (Enak ya?)",
  },
  {
    kana: "よ",
    romaji: "Yo (Lho!)",
    desc: "Di akhir kalimat untuk memberi penekanan atau informasi baru.",
    example: "Atsui desu yo (Panas lho!)",
  },
];
